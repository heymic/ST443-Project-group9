...
#Creating categorical variables and some transformations!
...
```{r}
test_df[test_df$MSSubClass == 150,] 
test_df[test_df$MSSubClass == 150,"MSSubClass"] <- 120
test_df$MSSubClass <- as.factor(as.numeric(test_df$MSSubClass))
