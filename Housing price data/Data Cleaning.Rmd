...
---
```{r}
train = read.csv("C:/Users/kevin/Downloads/train.csv", row.names = "Id", stringsAsFactors=FALSE)
```
...
Divide housestyle into 3 bands from its continuous value: Dont understand his syntax
...
Regrouped the different categories of exterior if more than one material into 3 bands: Syntax of the Summarize command
